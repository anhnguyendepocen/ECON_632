    ...
    %for i = 1:sim_num;
     ...
     for j = 2:trunc_periods;
           ...
           for v = 1:num_exog_states;
               ...
               prev_draw = mat_trans_probs_0_1(demand_state_from,v)';
...
[estimate_hm_iter,log_like,exitflag,output,Gradient,Hessian] = fminunc(@(theta)mindistfunc(beta,theta,trunc_periods,state_sim,probs_sim,choice_sim,sim_num,mat_probs_in,mat_trans_probs),theta0,options);
